...
import { PRICES, SERVICE_NAMES, formatPrice, formatNumber, formatDateThai } from '../config'
...
function ReceiptAll() {
  ...
  const { member, serviceName, weightKg, servicePrice, riceBranKg, huskKg, riceChunksKg, brokenRiceKg, totalPrice, earnedPoints } = data
      ...
      <div className="receipt-container">
        ...
        <table className="receipt-table">
          ...
          <tbody>
            <tr>
              <td>{serviceName}</td>
              <td>{formatNumber(weightKg)} กก.</td>
